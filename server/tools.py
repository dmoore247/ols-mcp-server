"""Tools module for the OLS MCP server.

This module defines all the tools that the MCP server exposes for interacting
with the Ontology Lookup Service (OLS) API.
"""
...
def load_tools(mcp_server):
    """Register all OLS MCP tools with the server."""
